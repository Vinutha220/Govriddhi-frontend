...
export default function GohomePage() {
  const goshala = localStorage.getItem("goshala") || "Your Goshala"; // Default value if null
      ...
      <div className="hero-section" style={{ backgroundImage: "url('/images/GohomeImg.jpg')" }}>
        <div className="overlay">
          <div className="hero-content">
            <h3 className="hero-title">A Sanctuary of Kindness – Welcome to {goshala}!</h3>
            <p className="hero-subtitle">Heaven on Earth</p>
            <p className="hero-subtitle2">ART OF LIVING GAUSHALA</p>
